...
const FlipBtn = ({ Flip }: Props) => (
  <button onClick={Flip} className="flex items-center bg-primary hover:bg-accent p-2 rounded-sm text-xs text-base-200 hover:text-primary w-fit font-semibold cursor-pointer">
